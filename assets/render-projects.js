...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent =
      ...
      "[data-projects-grid] .pc .pn{font-size:var(--text-lg,18px);line-height:1.25;font-weight:700;letter-spacing:-.015em;margin-top:var(--space-4,16px);color:var(--tx,#f4f4f6)}" +
      "[data-projects-grid] .pc .pcl{font-size:var(--text-sm,12px);color:var(--tx2,#a3a3ae);margin-top:var(--space-1,4px)}" +
      "[data-projects-grid] .pc .pchips{margin:0 0 var(--space-4,16px);display:flex;justify-content:center;align-items:center;gap:var(--space-2,8px);flex-wrap:wrap}" +
      "[data-projects-grid] .pc .hpill{font-family:'JetBrains Mono',monospace;font-size:var(--text-xs,11px);letter-spacing:.04em;text-transform:uppercase;padding:var(--space-1,4px) var(--space-2,8px);border-radius:var(--r-pill,999px);display:inline-flex;align-items:center;gap:var(--space-1,4px);border:1px solid transparent}" +
      "[data-projects-grid] .pc .hpill .d{width:5px;height:5px;border-radius:var(--r-circle,50%)}" +
      ...
      "[data-projects-grid] .pc .hpill.health--on_track .d{background:var(--health-on-dot,#34d399)}" +
      ...
      "[data-projects-grid] .pc .hpill.health--at_risk .d{background:var(--health-risk-dot,#fbbf24)}" +
      ...
      "[data-projects-grid] .pc .hpill.health--blocked .d{background:var(--health-blk-dot,#f87171)}" +
      "[data-projects-grid] .pc .sp{font-family:'JetBrains Mono',monospace;font-size:var(--text-xs,11px);letter-spacing:.04em;text-transform:uppercase;padding:var(--space-1,4px) var(--space-2,8px);border-radius:var(--r-pill,999px);border:1px solid var(--line,rgba(255,255,255,.08));color:var(--tx2,#a3a3ae);background:rgba(255,255,255,.03)}" +
      "[data-projects-grid] .pc .barwrap{display:flex;align-items:center;gap:var(--space-2,8px);width:100%;margin-top:var(--space-4,16px)}" +
      "[data-projects-grid] .pc .bar{flex:1;height:5px;border-radius:var(--r-pill,999px);background:rgba(255,255,255,.09);overflow:hidden;margin:0}" +
      "[data-projects-grid] .pc .bar i{display:block;height:100%;border-radius:var(--r-pill,999px);background:var(--grad-soft,linear-gradient(135deg,#6d5efc,#8b7cff))}" +
      "[data-projects-grid] .pc .pct{font-family:'JetBrains Mono',monospace;font-size:var(--text-xs,11px);color:var(--tx2,#a3a3ae);min-width:30px;text-align:right}" +
      ...
      "[data-projects-grid] .pc .pfoot{font-family:'JetBrains Mono',monospace;font-size:var(--text-xs,11px);color:var(--tx2,#a3a3ae);letter-spacing:.1em;text-transform:uppercase;margin-top:var(--space-4,16px)}" +
